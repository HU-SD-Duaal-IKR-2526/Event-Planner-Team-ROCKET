...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<StandardError> eventNotFound(
    ...
    public ResponseEntity<StandardError> roleNotAllowed(
            RoleNotAllowedException e, HttpServletRequest request) {
        StandardError err = new StandardError();
        err.setTimestamp(Instant.now());
    ...
    public ResponseEntity<StandardError> wrongDateFormat(
            WrongDateFormatException e, HttpServletRequest request) {
        StandardError err = new StandardError();
        err.setTimestamp(Instant.now());
    ...
    public ResponseEntity<StandardError> invalidEnumValue(
